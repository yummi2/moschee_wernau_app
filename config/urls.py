...
urlpatterns = [
    ...
    path('live-wettbewerb/<int:game_id>/', views.live_competition_game, name='live_competition_game'),
    ...
    path("ramadan/results/", views.ramadan_results, name="ramadan_results"),
]
